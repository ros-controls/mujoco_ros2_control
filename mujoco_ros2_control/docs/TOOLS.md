...
> [!NOTE]
> This page focuses on generating MJCFs for robots.  Please see additional documentation on [modeling complex geometries in MuJoCo](./MODELING_TIPS.md) and [generating object MJCFs](./OBJECT_MJCFS.md).
...
- `raw_inputs`: arbitrary MJCF XML fragments that will get copied into the generated
  ...
  - Can also exclude contacts between bodies using the [`contact` tag](https://mujoco.readthedocs.io/en/stable/XMLreference.html#contact).
